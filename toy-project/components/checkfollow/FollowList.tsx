  ...
  return (
    <section className="commonBackground flex h-[480px] w-full flex-col">
      <div className="flex justify-end gap-[14px] px-[25px] py-[20px]">
        <button className="commonButton h-[25px] w-[60px] bg-white text-black">모두 선택</button>
        <button className="commonButton h-[25px] w-[60px] bg-white text-black">모두 해지</button>
      </div>
